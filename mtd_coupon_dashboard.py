...
and BUS_DATE between date_trunc('month', current_date) and last_day(current_date)
group by 1"""
...
try:
    corp2.execute("delete from crm@dw_prd:uac_coup_mtd")
...
and d.IS_GOSHP_ID=0
and d.STORE_ID<>9000
and d.BUS_DATE between date_trunc('month', current_date) and last_day(current_date)
...
for y in x[0:]:
    ...
    query="""insert into 
    crm@dw_prd:uac_coup_mtd(item_id, coupon_description, revenue, item_cost, margin_dlr, margin_pct, total_transactions, 
